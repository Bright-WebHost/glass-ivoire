      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-sm font-semibold uppercase tracking-[0.32em] text-accent-slate mb-4">Get in touch</p>
            ...
            <p className="text-lg leading-8 text-slate-700">
              Reach out for consultations, technical support, and bespoke glass solutions tailored to your construction, housing, or architectural projects.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="rounded-[2rem] bg-white/70 backdrop-blur-md border border-white p-8 shadow-soft relative overflow-hidden group hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-xl font-semibold text-primary-dark mb-4">Our Headquarters</h3>
              ...
              <div className="grid gap-8 sm:grid-cols-2">
                <div className="rounded-[2rem] bg-white/70 backdrop-blur-md border border-white p-8 shadow-soft hover:shadow-lg transition-shadow duration-300">
                  <h3 className="text-lg font-semibold text-primary-dark mb-5">Contact</h3>
                  <div className="space-y-4">
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-teal mb-1">Phone</p>
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-teal mb-1">General Inquiries</p>
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-teal mb-1">Sales</p>
                ...
                <div className="rounded-[2rem] bg-white/70 backdrop-blur-md border border-white p-8 shadow-soft hover:shadow-lg transition-shadow duration-300">
                  <h3 className="text-lg font-semibold text-primary-dark mb-5">Hours</h3>
                  <div className="space-y-4">
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-slate mb-1">Mon - Fri</p>
                      <p className="text-sm font-medium text-slate-700">{siteConfig.businessHours.weekdays}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-slate mb-1">Saturday</p>
                      <p className="text-sm font-medium text-slate-700">{siteConfig.businessHours.saturday}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-widest text-accent-slate mb-1">Sunday</p>
